...
export function Product({ id, title, price, imageUrl, isLiked }) {
    const dispatch = useDispatch();

    return (
        <div className="item">
            <NavLink to={`/catalog/${id}`} className="max-h-80 overflow-hidden mb-2">
            ...
            <div className="px-2 pb-2 flex justify-between items-center gap-2">
                ...
                <div className="flex gap-2">
                    <button onClick={() => dispatch(addToFavorite({ id: id }))} className={isLiked ? 'liked' : 'btn-icon'}>
                        <svg className={isLiked ? '*:fill-red-500' : '*:fill-stone-400'} width="20" height="20" viewBox="0 0 265 216" fill="none" xmlns="http://www.w3.org/2000/svg">
